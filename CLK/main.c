...
volatile uint8_t hour=7;	 // example values for hour and minute
volatile uint8_t mode=0; 	 // if 0: Adjust brightness, 1: Adjust minutes, 2: Adjust hours
volatile uint8_t button=0;
volatile uint8_t pwm_mode=0; // [0..3] LEDs off to brightest setting
